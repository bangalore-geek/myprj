...
public class CompanyProfileController {
	...
	@Menu(title = "Course List", url = "/corpyogi/kv/corpprofile", accessCode = "ROLE_DF_CREATE_ROLE", order = 1, visible = true)
	@RequestMapping(value = "/corpyogi/kv/corpprofile", method = RequestMethod.GET)
	...
	public ModelAndView createRole(HttpServletRequest request) {
		...
		return new ModelAndView("company-profile", model);
	}
