...
public class ExcelImporterController {
	...
	@Menu(title = "Course List", url = "/corpyogi/kv/importer", accessCode = "ROLE_DF_CREATE_ROLE", order = 1, visible = true)
	@RequestMapping(value = "/corpyogi/kv/importer", method = RequestMethod.GET)
