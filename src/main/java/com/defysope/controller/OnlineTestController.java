...
public class OnlineTestController {
	...
	@RequestMapping(value = "/load-test-details", method = RequestMethod.GET)
	@Secured("ROLE_DF_HOME_PAGE")
	@ResponseBody
	public Object loadData(HttpServletRequest request) {
		...
		AssesmentMaster course =  manager.getObjectOrNull(AssesmentMaster.class, trainee.getAssesmentMasterId());
		AssesmentCourse training = manager.getObjectOrNull(AssesmentCourse.class, trainee.getAssesmentMasterTrainingId());
