...
public class ManageAssessmentController {
	...
	@Menu(title = "Manage Assessment", url = "/corpyogi/kv/manageassessment", accessCode = "ROLE_DF_CREATE_ROLE", order = 1, visible = true)
	@RequestMapping(value = "/corpyogi/kv/manageassessment", method = RequestMethod.GET)
	...
	public ModelAndView createRole(HttpServletRequest request) {
		...
		return new ModelAndView("manage-assessment", model);
	}
}
