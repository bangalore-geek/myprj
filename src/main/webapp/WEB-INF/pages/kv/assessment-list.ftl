		...
		<div class="col-md-10">
			<div  style="padding:10px;">
				<accordion class="accordion" close-others="true">
					<accordion-group ng-init="isOpen = $first" is-open="isOpen" ng-repeat="group in trainings">
						<accordion-heading>
...
<@macro.showFooter>
<script type="text/javascript" src="${rc.getContextPath()}/resources/js/pages/kv/assessment-list.js"></script>
</@macro.showFooter>