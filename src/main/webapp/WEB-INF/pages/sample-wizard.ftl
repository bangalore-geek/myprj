					...
					<div class="col-md-5">			
						<div style="margin-top:40px;">
							<form class="form-horizontal">
								<div class="form-group">
									<label for="assesmentMasterTrainingId" class="col-sm-4 control-label">Training</label>
									<div class="col-sm-8">
										<select ng-model="thisTrainee.assesmentMasterTrainingId" name="assesmentMasterTrainingId" class="form-control" ng-change="loadTrainee(thisTrainee.assesmentMasterTrainingId)">
